function makeTree(flare, container_selector, page_width, page_height) {
  container_selector = container_selector || 'body';
  page_width = page_width || 960;
  page_height = page_height || 800;

  var margin = {top: 20, right: 120, bottom: 20, left: 120},
      width = page_width - margin.right - margin.left,
